        ...
        <div class="flex items-center gap-3">
            ...
            <div class="relative inline-block">
                ...
                <button
                    ...
                    class="flex items-center justify-between min-w-44 h-11 px-4
                        bg-white border border-gray-200 rounded-xl shadow-sm
                        text-sm font-medium text-gray-700
                        hover:border-primary-400 hover:shadow-md
                        focus:ring-4 focus:ring-primary-100
                ...
                <div id="statusDropdown"
                    class="hidden z-20 w-52 mt-2 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden cursor-pointer">
                    ...
                    <table class="w-full text-sm text-left">
                        <thead>
                            <tr class="bg-slate-200 dark:bg-gray-700">
                                ...
                                <th class="px-4 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider">Kode</th>
                                <th class="px-4 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider">Nama</th>
                                <th class="px-4 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider">Deskripsi</th>
                        ...
                        @foreach($products as $i => $product)
                            <tr class="border-b border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                <td class="px-4 py-3 text-xs text-gray-400">{{ $products->firstItem() + $i }}</td>
                                ...
                                <td class="px-4 py-3">
                                    <span class="text-xs text-gray-600">{{ $product->deskripsi ? \Illuminate\Support\Str::limit($product->deskripsi, 60) : '-' }}</span>
                                </td>
