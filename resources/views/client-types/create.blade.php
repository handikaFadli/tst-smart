...
@section('title', 'Tambah Tipe Klien')

@section('content')
<div class="px-4 pt-6 pb-10 max-w-5xl mx-auto">

    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Tipe Klien</h1>
        {{-- <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Masukkan nama dan deskripsi untuk tipe klien</p> --}}
    </div>
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 mb-5 shadow-xs">
            <div class="flex items-center gap-2 mb-5">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400">Isi detail tipe klien baru</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama') }}" placeholder="Sekolah/Bimbel/Perusahaan/Ponpes" 
