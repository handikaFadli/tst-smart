...
@section('title', 'Tambah Fitur Aplikasi')

@section('content')
<div class="px-4 pt-6 pb-10 max-w-5xl mx-auto">

    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Fitur Aplikasi</h1>
    </div>
    ...
    <form action="{{ route('features.store') }}" method="POST">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 mb-5 shadow-xs">
            <div class="flex items-center gap-2 mb-5">
                ...
                <div>
                    <h2 class="text-sm font-semibold text-gray-900 dark:text-white">Informasi Fitur Aplikasi</h2>
                    <p class="text-xs text-gray-400">Isi detail fitur baru</p>
                </div>
            </div>
            <div class="grid grid-cols-1 gap-4">
                <div>
                    <label for="kode" class="block mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-300">
                        Kode <span class="text-red-500">*</span>
                    </label>
                    <input type="text" name="kode" id="kode" value="{{ old('kode') }}" placeholder="Contoh: ujian" 
                ...
                <div>
                    <label for="nama_fitur" class="block mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-300">
                        Fitur <span class="text-red-500">*</span>
                    </label>
                    <input type="text" name="nama_fitur" id="nama_fitur" value="{{ old('nama_fitur') }}" placeholder="Contoh: Ujian" 
                           class="block w-full px-3 py-2.5 text-sm text-gray-900 border-gray-300 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 transition">
                    @error('nama_fitur')
                        <p class="mt-1 text-xs text-red-500 flex items-center gap-1">
                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
