...
<div class="px-4 pt-6 pb-10 max-w-7xl mx-auto w-full min-w-0">
    ...
    {{-- Header --}}
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Buat Tiket</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Buat tiket baru untuk melaporkan kendala atau permintaan bantuan.
        </p>
    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="">
                                ...
                                <select name="assigned_to"
                                    ...
                                    @foreach(\App\Models\User::all() as $support)
                                        <option value="{{ $support->id }}"
                                            {{ old('assigned_to') == $support->id ? 'selected' : '' }}>
                                            {{ $support->name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">
                                    Buat judul singkat namun mudah dipahami.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">
                                    Sertakan kronologi dan error jika ada.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">
                                    Lampiran membantu support lebih cepat.
                                </p>
                            </div>
                        </div>
