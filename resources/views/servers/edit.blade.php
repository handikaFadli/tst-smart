...
<div class="px-4 pt-6 pb-10 max-w-5xl mx-auto">
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Server</h1>
        {{-- <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Isi data server</p> --}}
    </div>
    ...
    <form action="{{ route('servers.update', $server) }}" method="POST">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 mb-5 shadow-xs">
            ...
            <div class="flex items-center gap-2 mb-5">
                ...
                <div>
                    <h2 class="text-sm font-semibold text-gray-900 dark:text-white">Informasi Server</h2>
                    <p class="text-xs text-gray-400">Perbarui detail server</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $server->nama) }}" placeholder="Contoh: Server 1"
                ...
                <div>
                    <label for="ip_address" class="block mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-300">IP Address</label>
                    <input type="text" name="ip_address" id="ip_address" value="{{ old('ip_address', $server->ip_address) }}" placeholder="Opsional"
                           class="block w-full px-3 py-2.5 text-sm text-gray-900 border-gray-300 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 transition">
                    @error('ip_address')
                        <p class="mt-1 text-xs text-red-500 flex items-center gap-1">
                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                ...
                <div>
                    <label for="catatan" class="block mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-300">Catatan</label>
                    <textarea name="catatan" id="catatan" rows="3" placeholder="Sharing/Mandiri"
                              class="block w-full px-3 py-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 transition resize-none">{{ old('catatan', $server->catatan) }}</textarea>
                    @error('catatan')
                        <p class="mt-1 text-xs text-red-500 flex items-center gap-1">
                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                            {{ $message }}
