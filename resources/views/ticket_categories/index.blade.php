                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex justify-center gap-1">
                                        ...
                                        <form id="delete-form-{{ $ticketCategory->id }}" action="{{ route('ticket-categories.destroy', $ticketCategory->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                                                    onclick="openDeleteModal('delete-form-{{ $ticketCategory->id }}', '{{ $ticketCategory->nama }}')"
